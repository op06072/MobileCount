...
def leading_data(
    ...
    img_transform = standard_transforms.Compose([
        standard_transforms.Resize(cfg_data.STD_SIZE),
    ...
    train_set = MALL(
        os.path.realpath(cfg_data.DATA_PATH) + '/train', main_transform=train_main_transform,
    ...
    if cfg_data.TRAIN_BATCH_SIZE == 1:
        ...
        train_loader = DataLoader(
            ...
            collate_fn=MALL_collate, drop_last=True, persistent_workers=(data_workers != 0),
        )

    val_set = MALL(
        os.path.realpath(cfg_data.DATA_PATH) + '/test', main_transform=None,
        img_transform=img_transform, gt_transform=gt_transform
    )
