...
class MobileCountV3(nn.Module):
    def __init__(self, backbone="large", pretrained=True):
        super(MobileCountV3, self).__init__()
        ...
        if backbone == "large":
            ...
            self.in_channels = [24, 40, 112, 960]
        elif backbone == "small":
